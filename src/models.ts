...
export interface AdvancedHttpClientOptions {
  ...
  useRetry?: boolean;
  useRetryOptions?: UseRetryInterceptorOptions;
  useLogging?: boolean;
  useCorrelationId?: boolean;
  useCorrelationIdOptions?: UseCorrelationIdInterceptorOptions;
  useGetNotFoundReturnNull?: boolean;
  useCaching?: boolean;
  useCachingOptions?: UseCachingInterceptorOptions;
}
...
export interface UseRetryInterceptorOptions {
  ...
  retryOnStatusCodeRanges?: [HttpStatusCode, HttpStatusCode][];
  supportedMethodsForRetry?: HttpMethod[];
}

export interface UseCorrelationIdInterceptorOptions {
...
export interface HttpCache<TKey, TValue> {
